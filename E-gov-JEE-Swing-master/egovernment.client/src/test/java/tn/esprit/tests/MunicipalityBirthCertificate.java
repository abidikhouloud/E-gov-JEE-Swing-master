...
public class MunicipalityBirthCertificate extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MunicipalityBirthCertificate frame = new MunicipalityBirthCertificate();
	...
	public MunicipalityBirthCertificate() {
