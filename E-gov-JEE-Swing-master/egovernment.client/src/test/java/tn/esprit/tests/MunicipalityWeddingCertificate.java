...
public class MunicipalityWeddingCertificate extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MunicipalityWeddingCertificate frame = new MunicipalityWeddingCertificate();
	...
	public MunicipalityWeddingCertificate() {
...
//		});
		...
		btnNewButton_1.setBounds(339, 387, 191, 90);
		contentPane.add(btnNewButton_1);
		
		JLabel jepouse = new JLabel((String) null);
		jepouse.setBounds(339, 267, 213, 33);
		contentPane.add(jepouse);
		...
		mun=MunicipalityGestionDelegator.birthCertificateByCin(MunicipalityMain.cinn);
		System.out.println(MunicipalityMain.cinn);
		System.out.println("*****************");
		System.out.println(mun.getFname());
		System.out.println("*****************");
		System.out.println(mun.getGender());
		System.out.println("*****************");
		*/
			Man m =new Man();
			m=MunicipalityGestionDelegator.weddingCertificateMan(MunicipalityMain.cinn);
			System.out.println("////////////////////////");
			System.out.println(m);
			jepoux.setText(m.getFname());
			jepouse.setText(m.getWoman().getFname());
